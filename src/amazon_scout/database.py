...
CREATE TABLE IF NOT EXISTS serpapi_relevance_runs (id INTEGER PRIMARY KEY, run_id INTEGER NOT NULL REFERENCES research_runs(id), niche TEXT NOT NULL, keyword TEXT NOT NULL, rule_version TEXT NOT NULL, aggregates_json TEXT NOT NULL, classified_results_json TEXT NOT NULL, excluded_results_json TEXT NOT NULL);
